...
exports.world = world;
world.registerComponent(_components.Ball).registerComponent(_components.CanvasContext).registerComponent(_components.Collidable).registerComponent(_components.Movement).registerComponent(_components.Position).registerComponent(_components.Paddle).registerComponent(_components.Radius).registerComponent(_components.Render).registerComponent(_components.Size).registerSystem(_systems.CollisionSystem).registerSystem(_systems.RendererSystem).registerSystem(_systems.BallSystem).registerSystem(_systems.MovementSystem); // Get reference to the HTML canvas element

const canvas = document.getElementById("game"); // Create CanvasContext entity and provide it the canvas context and dimensions
...
const pongScene = new _scenes.PongScene(world, canvas);
const ballsScene = new _scenes.BallsScene(world, canvas);
ballsScene.load(); // Implement game loop
...
},{"./Ball":"d4f02189eeb67b545e76e59f66ae327c","./CanvasContext":"4050e4983ef1077eba381edd0d873b5d","./Movement":"2a909d6e6952b739a25e470cc73080c6","./Paddle":"e777600aed3f8e033b6744f713d21fe0","./Position":"602bd3e58e730389dccdff74e9b8cc0a","./Radius":"36e5ea3379cdf7e60cf4554dd22021bb","./Size":"5eef90d0585b062f7e99143817485f1d","./Render":"bd81df209c203f3820d27e7f06d12b22","./Collidable":"8d86011ac6cefb462a55f142d4b43f81"}],"d4f02189eeb67b545e76e59f66ae327c":[function(require,module,exports) {
"use strict";
...
class Ball extends _ecsy.TagComponent {}

exports.Ball = Ball;
},{"ecsy":"322d3b240f66735bb9b56aa9d97788a0"}],"4050e4983ef1077eba381edd0d873b5d":[function(require,module,exports) {
"use strict";
...
},{"ecsy":"322d3b240f66735bb9b56aa9d97788a0"}],"2a909d6e6952b739a25e470cc73080c6":[function(require,module,exports) {
"use strict";
...
class Movement extends _ecsy.Component {}

exports.Movement = Movement;

_defineProperty(Movement, "schema", {
  direction: {
...
},{"ecsy":"322d3b240f66735bb9b56aa9d97788a0"}],"e777600aed3f8e033b6744f713d21fe0":[function(require,module,exports) {
"use strict";
...
class Paddle extends _ecsy.Component {}

exports.Paddle = Paddle;

_defineProperty(Paddle, "schema", {
  playerIndex: {
    type: _ecsy.Types.Number
  }
});
},{"ecsy":"322d3b240f66735bb9b56aa9d97788a0"}],"602bd3e58e730389dccdff74e9b8cc0a":[function(require,module,exports) {
"use strict";
...
class Position extends _ecsy.Component {}

exports.Position = Position;

_defineProperty(Position, "schema", {
  value: {
    type: _Vector2Type.Vector2Type,
    default: new _Vector2Type.Vector2()
  }
});
},{"ecsy":"322d3b240f66735bb9b56aa9d97788a0","../types/Vector2Type":"0d144aba2d0394558ce3f8bf75078649"}],"36e5ea3379cdf7e60cf4554dd22021bb":[function(require,module,exports) {
"use strict";
...
},{"ecsy":"322d3b240f66735bb9b56aa9d97788a0"}],"5eef90d0585b062f7e99143817485f1d":[function(require,module,exports) {
"use strict";
...
},{"ecsy":"322d3b240f66735bb9b56aa9d97788a0","../types/Vector2Type":"0d144aba2d0394558ce3f8bf75078649"}],"bd81df209c203f3820d27e7f06d12b22":[function(require,module,exports) {
"use strict";
...
class Render extends _ecsy.Component {}

exports.Render = Render;

_defineProperty(Render, "schema", {
  primitive: {
...
},{"ecsy":"322d3b240f66735bb9b56aa9d97788a0"}],"8d86011ac6cefb462a55f142d4b43f81":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.Collidable = void 0;
...
class Collidable extends _ecsy.Component {}

exports.Collidable = Collidable;

_defineProperty(Collidable, "schema", {
  box: {
    type: _Vector2Type.Vector2Type,
    default: new _Vector2Type.Vector2()
  },
...
},{"./RendererSystem":"7492a0598b81b7202e3243a1e7828ebc","./MovementSystem":"11bf7ad375d9029eaad09408c3ef6622","./CollisionSystem":"603000d7ef661abab81f8828746c55e1","./BallSystem":"1f029996ae3a148757e7f47a9d8abcf8"}],"7492a0598b81b7202e3243a1e7828ebc":[function(require,module,exports) {
"use strict";
...
class RendererSystem extends _ecsy.System {
  execute() {
    ...
    const {
      ...
      width: canvasWidth,
      height: canvasHeight
    } = canvas.getComponent(_components.CanvasContext);
    ctx.fillStyle = "black";
    ...
    this.queries.renderables.results.forEach(entity => {
      const {
        primitive,
        isEnabled
      } = entity.getComponent(_components.Render); // If not enabled, skip render
  ...
  renderRect(ctx, entity) {
    const {
      value: position
    } = entity.getComponent(_components.Position);
    const {
      value: size
...
class MovementSystem extends _ecsy.System {
  execute(delta) {
    ...
    movables.forEach(entity => {
      ...
      const movement = entity.getMutableComponent(_components.Movement);
      const position = entity.getMutableComponent(_components.Position); // If entity movement is not enabled, skip this

      if (!movement.isEnabled) return;

      let appliedMovement = _utils.VectorMath.multiply(movement.direction, movement.velocity);

      appliedMovement = _utils.VectorMath.multiply(appliedMovement, delta);
...
_defineProperty(MovementSystem, "queries", {
  movable: {
    components: [_components.Movement, _components.Position]
  }
});
...
},{"./Random":"3b6ca754cb6df94668213983e316db17","./VectorMath":"8c1a49eef4c6f1a4a0600d269a9bf9e1"}],"3b6ca754cb6df94668213983e316db17":[function(require,module,exports) {
"use strict";
...
class Random {
  ...
  static getRandomDirection() {
    return new _Vector2Type.Vector2(Random.getRandomArbitrary(-1, 1), Random.getRandomArbitrary(-1, 1));
  }
...
},{"../types/Vector2Type":"0d144aba2d0394558ce3f8bf75078649"}],"603000d7ef661abab81f8828746c55e1":[function(require,module,exports) {
"use strict";
...
class CollisionSystem extends _ecsy.System {
  execute() {
    ...
    const canvas = canvasEntity.getComponent(_components.CanvasContext);
    collidables.forEach(entity => {
      // Get entity components
      const collision = entity.getMutableComponent(_components.Collidable);
      const position = entity.getMutableComponent(_components.Position); // Check collision against stage Y
...
_defineProperty(CollisionSystem, "queries", {
  ...
  collidables: {
    components: [_components.Collidable]
  }
});
},{"ecsy":"322d3b240f66735bb9b56aa9d97788a0","../components":"bc610deadc54a08eda6642f8b91e1a0d"}],"1f029996ae3a148757e7f47a9d8abcf8":[function(require,module,exports) {
"use strict";
...
class BallSystem extends _ecsy.System {
  execute() {
    ...
    balls.forEach(entity => {
      // Get entity components
      const collision = entity.getComponent(_components.Collidable);
      const movement = entity.getMutableComponent(_components.Movement);
...
var _BallsScene = require("./BallsScene");

Object.keys(_BallsScene).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _BallsScene[key];
    }
  });
});
...
},{"./BallsScene":"57edd1ac63118ee327b0a7784d678e29","./PongScene":"301d1b66b4d9cd046fc421f9a52cd502"}],"57edd1ac63118ee327b0a7784d678e29":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.BallsScene = void 0;
...
class BallsScene extends _Scene.Scene {
  constructor(...args) {
    super(...args);

    _defineProperty(this, "balls", []);
  }
  ...
  load() {
    ...
    for (let i = 0; i < NUMBER_OF_BALLS; i++) {
      this.balls[i] = (0, _entities.createBall)(this.world, new _Vector2Type.Vector2(_utils.Random.getRandomArbitrary(0, this.canvas.width), _utils.Random.getRandomArbitrary(0, this.canvas.height)), _utils.Random.getRandomDirection(), 10, 10);
    }
  }
...
exports.BallsScene = BallsScene;
},{"./Scene":"32d533d99164b98ccb6cdf15c8039c86","../entities":"c2ff81774f91016e94bad21cde8d2a79","../types/Vector2Type":"0d144aba2d0394558ce3f8bf75078649","../utils":"5f24944aa7d2b85fc56215858c2e7056"}],"32d533d99164b98ccb6cdf15c8039c86":[function(require,module,exports) {
"use strict";
...
exports.Scene = Scene;
},{}],"c2ff81774f91016e94bad21cde8d2a79":[function(require,module,exports) {
"use strict";
...
},{"./Ball":"43a6873d0a273f8c4c3a79170087ada5","./Paddle":"1cf54e7dde9caa6ec70000dabc60298a"}],"43a6873d0a273f8c4c3a79170087ada5":[function(require,module,exports) {
"use strict";
...
function createBall(world, position, direction, velocity, radius) {
  return world.createEntity().addComponent(_components.Ball).addComponent(_components.Render, {
    primitive: "circle"
  }).addComponent(_components.Movement, {
    direction,
    velocity
  }).addComponent(_components.Position, {
    value: position
  }).addComponent(_components.Radius, {
    value: radius
  }).addComponent(_components.Collidable, {
    box: new _Vector2Type.Vector2(10, 10)
  });
}
},{"../components":"bc610deadc54a08eda6642f8b91e1a0d","../types/Vector2Type":"0d144aba2d0394558ce3f8bf75078649"}],"1cf54e7dde9caa6ec70000dabc60298a":[function(require,module,exports) {
"use strict";
...
function createPaddle(world, playerIndex, position, direction, velocity, size) {
  return world.createEntity().addComponent(_components.Paddle, {
    playerIndex
  }).addComponent(_components.Render, {
    primitive: "rect"
  }).addComponent(_components.Movement, {
    direction,
    velocity
...
},{"../components":"bc610deadc54a08eda6642f8b91e1a0d"}],"301d1b66b4d9cd046fc421f9a52cd502":[function(require,module,exports) {
"use strict";
...
class PongScene extends _Scene.Scene {
  load() {
    // Instantiate a circle entity on the middle of the canvas
    this.ball = (0, _entities.createBall)(this.world, new _Vector2Type.Vector2(this.canvas.width / 2, this.canvas.height / 2), _utils.Random.getRandomDirection(), 10, 10); // Instantiate paddles

    const paddleSize = new _Vector2Type.Vector2(20, 100); // Player 1

    this.paddle1 = (0, _entities.createPaddle)(this.world, 0, new _Vector2Type.Vector2(10, this.canvas.height / 2 - paddleSize.y / 2), new _Vector2Type.Vector2(), 10, paddleSize); // Player 2

    this.paddle2 = (0, _entities.createPaddle)(this.world, 1, new _Vector2Type.Vector2(this.canvas.width - paddleSize.x - 10, this.canvas.height / 2 - paddleSize.y / 2), new _Vector2Type.Vector2(), 10, paddleSize);
  }
...
},{"./Scene":"32d533d99164b98ccb6cdf15c8039c86","../entities":"c2ff81774f91016e94bad21cde8d2a79","../types/Vector2Type":"0d144aba2d0394558ce3f8bf75078649","../utils":"5f24944aa7d2b85fc56215858c2e7056"}]},{},["41671e6ffbb618e7e29ef6b38e78fb96","7843b3960e086726267ff606847fc92b"], null)
